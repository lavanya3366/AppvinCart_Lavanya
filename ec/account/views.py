...
#         if serializer.is_valid(raise_exception=True):
#             return Response({'msg':'Pssword Changed Successfully'},status=status.HTTP_200_OK)
#         return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
...
#         if serializer.is_valid(raise_exception=True):
#             return Response({'msg':'Password reset link send check your mail'}, status=status.HTTP_200_OK)
#         return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
